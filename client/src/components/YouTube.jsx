...
function SkeletonCard() {
  return (
    <div className="yt-card yt-card--skeleton">
      <div className="yt-card__thumb yt-card__thumb--skeleton" />
      <div className="yt-card__body">
        <div className="yt-skeleton-line yt-skeleton-line--title" />
        <div className="yt-skeleton-line yt-skeleton-line--meta" />
      </div>
    </div>
  );
}
